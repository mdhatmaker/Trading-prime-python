...
print "Creating data file of ratio comparing two calendar spreads (values as returns)..."
...
filename1 = "QHO_calendar_0_3.csv"
filename2 = "QHO_calendar_0_6.csv"
output_filename = "ho_contango_ratio.csv"

########## COMPARE CONTANGO OF TWO DIFFERENT CALENDAR SPREADS ##########
print "-----CALCULATING CONTANGO RATIOS-----"

df1 = read_csv(join(project_folder, filename1))
